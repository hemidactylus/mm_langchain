...
loader = MMDisjointWebBaseLoader(
    "https://gist.github.com/hemidactylus/f2371591318128e3af9840d86699a9e9"
)
...
for doc_i, doc in enumerate(docs):
    ...
    if "image" in doc.content:
        print(
            f"        image => {doc.content['image'].size} (from {doc.metadata['image_url']})"
        )
